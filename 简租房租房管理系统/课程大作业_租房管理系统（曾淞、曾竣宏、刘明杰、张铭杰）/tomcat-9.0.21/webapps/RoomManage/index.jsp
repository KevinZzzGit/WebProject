...
<script>"undefined"==typeof CODE_LIVE&&(!function(e){var t={nonSecure:"20106",secure:"20111"},c={nonSecure:"http://",secure:"https://"},r={nonSecure:"127.0.0.1",secure:"gapdebug.local.genuitec.com"},n="https:"===window.location.protocol?"secure":"nonSecure";script=e.createElement("script"),script.type="text/javascript",script.async=!0,script.src=c[n]+r[n]+":"+t[n]+"/codelive-assets/bundle.js",e.getElementsByTagName("head")[0].appendChild(script)}(document),CODE_LIVE=!0);</script></head>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-0" data-genuitec-path="/RoomManger/WebRoot/index.jsp" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/RoomManage/WebRoot/index.jsp">
	  <!--状态判断  -->
	  <%
	  ...
	  %>
		<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/RoomManage/WebRoot/index.jsp">
		...
		<div id="mian">
			...
			<div class="main-right">
				...
				<div id="login" class = "form-group">
					...
					<p align="center"><input type="button" value="Login" class="btn btn-primary" onclick="location.href='manage/manage.jsp'"/></p>
				</div>
				 <%
				 	}
				  %>
