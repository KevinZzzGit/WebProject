			...
			<tbody>
				...
				<s:iterator value="#request.tables" status="tables">
					<tr>
						...
						<td>
							<button class="btn btn-info"  onclick="document.location='<%=basePath%>selectTablesId?tables.pkTables=<s:property value="pkTables"/>'">修改</button>
							<button class="btn btn-danger" onclick="document.location='<%=basePath%>deleteTable?tables.tablesId=<s:property value="tablesId"/>'">删除</button>
						</td>
					</tr>
				</s:iterator>
			</tbody>
